...
Для того чтобы увидеть изменения во всех ветках,нужно ввести команду:
...
<<<<<<< HEAD
Для перехода на другую ветвь введите команду:
...
Что бы посмотреть какие ветки сейчас существуют необходимо ввести команду:
